  ...
  return (
    <div className='border'>
        <form onSubmit={handleSubmit(onSubmit)} className="">
            ...
            <div className='mx-[6%] grid gap-y-4 my-4'>
              <div className="">
                  <label
                      htmlFor="title"
              ...
              <div className='flex-row md:flex gap-4'>
                ...
                <div className="w-[30%]">
                    ...
                    <input
                        type="file"
                        className="lock w-full px-4 py-6 mt-2 text-indigo-700 bg-white focus:border-indigo-400 focus:ring-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40"
              ...
              <div className="flex justify-center">
                <button
                    type="button"
                    className="w-[20%] px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-indigo-400 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600"
                    onClick={() => {
                      appendQuestion({
                        questionText: '',
                        options: [
