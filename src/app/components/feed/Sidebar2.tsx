    ...
    <div className="h-screen flex flex-col gap-4">
      <div className="p-3">
        <div className="text-center flex flex-col justify-center items-center">
          <h2 className="font-semibold text-[20px]">Bienvenida/o a Spacio!</h2>
          <div>
            <svg
        ...
        <div className='mt-[10px]'>
          <div className="text-center border-b border-gray-300">
            Explora contenido interesante, interactúa con la comunidad y disfruta de tu experiencia en nuestro sitio.
          </div>
        </div>
        <div className='flex flex-col gap-6 mt-3'>
          <div className='text-center'>
            Si quieres <span className='font-medium'>crear</span> contenido, puedes ir a la página directamente desde <a className='underline underline-offset-2 text-blue-700' href="/home/create">aquí</a> o desde la barra de navegación.
          </div>
          <div className='text-center'>
            Si quieres <span className='font-medium'>explorar</span> contenido, puedes ir a la página directamente desde <a className='underline underline-offset-2 text-blue-700' href="/home/explore">aquí</a> o desde la barra de navegación.
          </div>
        </div>
      </div>
    </div>
