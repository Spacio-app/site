...
const LoadMore = ({ session }: any) => {
  ...
  const LoadMoreFeed = () => {
    setTimeout(async () => {
      ...
      // if no more content to load, stop
  ...
  return (<>
    ...
    {
      noMoreContent
        ? <div className='text-center pb-8'>No hay mas contenido para mostrar</div>
        : <div className='flex flex-col justify-center items-center py-4' ref={ref}>
          <div role="status">
