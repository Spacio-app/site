...
const Feed = async () => {
  ...
  return (
    <section className="flex lg:gap-2 md:mx-[10%] lg:mx-[0%]">
      ...
      <div className="grid gap-9 h-fit lg:w-[50%] xl:w-[60%] border-gray-300 mx-auto my-6">
        <div className='flex justify-center items-center gap-6'>
          <h2 className="font-semibold text-[25px] md:text-[30px] text-center">
              Bienvenida/o a <span className='text-[#037AF6]'>Spacio!</span> <span className='capitalize'>{ capitalizeWords(session?.user.name) }</span>
              <span className='ml-4 inline-block justify-center items-center'>
                <svg
